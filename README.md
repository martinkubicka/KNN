    ...
    - dataset must be in format: 
        dataset/
            ...
            test/
                ...
                labels/
                    *.txt
    - name of image and label must match

4. Allocate GPU (for example: qsub -I -l select=1:ncpus=1:mem=32gb:ngpus=1:gpu_mem=16gb:scratch_local=50gb -l walltime=100:0:0 -q gpu_long)
