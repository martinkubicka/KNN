# Inspired by: https://github.com/YutingLi0606/HTR-VT/blob/main/model/HTR_VT.py 
...
from globals import EMBEDDING_DIM, PATCH_SIZE
...
### ViT Implementation with ResNet18 feature extractor
